...
class SubCategory(models.Model):
    ...
    photo1 = models.FileField(
        verbose_name="1 - Rasm", upload_to="subcategory", validators=[validate_image]
    )
    photo2 = models.FileField(
        verbose_name="2 - Rasm", upload_to="subcategory", validators=[validate_image]
    )
    photo3 = models.FileField(
        verbose_name="3 - Rasm", upload_to="subcategory", validators=[validate_image]
    )
    photo4 = models.FileField(
        verbose_name="4 - Rasm", upload_to="subcategory", validators=[validate_image]
    )
    category_id = models.ForeignKey(
        Category, on_delete=models.CASCADE, verbose_name="Mamlakat"
    )
...
class Product(models.Model):
    ...
    photo = models.FileField(
        verbose_name="Rasm", upload_to="products", validators=[validate_image]
    )
    country = models.ForeignKey(
        Category, on_delete=models.CASCADE, verbose_name="Davlati"
    )
    ...
    sub_id = models.ForeignKey(
        SubCategory, on_delete=models.CASCADE, verbose_name="SubKategoria"
    )
    created_at = models.DateTimeField(auto_now=True)
